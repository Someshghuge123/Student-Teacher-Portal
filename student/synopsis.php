      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="coordinatorlist.php">Synopsis</a>
          </div>
            ...
            <div class="col-md-12" >
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add Synopsis</h4>
                  <p class="card-category">add synopsis</p>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                       <div class="form-group">
						<label for="file">Cleck to Select File</label>
						<input type="file" class="btn btn-primary pull-right" name="file" id="file">
					  </div>
                      </div>
					  </div>
					 
                 
                    <button type="submit" name="submit" class="btn btn-primary pull-right">Upload Synopsis</button>
                    ...
                    <table class="table">
					  ...
					  <?php
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="<?php echo $row['path']; ?>" target="_blank">View
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" onclick="return confirmDel()" href="deletesynopsis.php?ID=<?php echo $row['id'];?>">
