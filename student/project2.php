...
<div id="wrapper">
	...
	<div class="">
		<div class="row">
			...
			<h3 class="bg-warning text-light text-center" style="border-radius: 25px;" font-size="18px";>Project Information :</h3>
				<div class="modal-content">
					<div class="modal-body">
						<form method='post' action=''>
							<div class="form-group input-group">
								<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
								<textarea rows="10" cols="150" type="text" class="bg-warning" name="project_info">
								</textarea>
							</div>

							<div class="form-group">
								<input type="submit" name="submit" class="btn btn-def bg-warning" value="Upload Project Info" />
							</div>
						</form>
						  ...
						  <tbody>
							...
							$sql = "SELECT * FROM student_project_info where student_id='$getID'";
...
if(isset($_POST['submit']))
{
	...
	$sql = "SELECT * FROM student_project_info ";
							//	$result=mysqli_query($db_found,$sql); //rs.open sql,con
							...
							while ($row=mysqli_fetch_array($result))
							{
								...
								{
									$sql2 = "UPDATE student_project_info SET info='$project_info' WHERE student_id='$stud_id'";
									mysqli_query($db_found,$sql2);
								
								}
								else{
									$sql2 = "INSERT INTO student_project_info (student_id,info) VALUES ('$stud_id','$project_info')";
									mysqli_query($db_found,$sql2);
