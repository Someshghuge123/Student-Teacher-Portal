            ...
            <div class="col-md-12" >
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">add project information</p>
                </div>
                <div class="card-body">
                    ...
                    <table class="table">
					  ...
					  <?php
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="viewprojectinfo.php?ID=<?php echo $row['id']; ?>">View
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" onclick="return confirmDel()" href="deleteprojectinfo.php?ID=<?php echo $row['id'];?>">
