...
<div id="wrapper">
	...
	<div class="">
		<div class="row">
			...
			<h3 class="bg-warning text-light text-center" style="border-radius: 25px;" font-size="18px";>President Task :</h3>
					...
					<div class="modal-body">
						  ...
						  <tbody>
							...
							$sql = "SELECT * FROM president_task where student_id='$getID'";
