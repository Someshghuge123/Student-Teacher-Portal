      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="coordinatorlist.php">Project Schedule</a>
          </div>
		...
		<div class="row">
            <div class="col-md-12" >
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">add new schedule</p>
                </div>
                <div class="card-body">
                  <form method='post' action=''>			  
                    <div class="row">
                      ...
                      <tbody>
					  <tr>
					  <td ><input style="width: 130px" type="date" name="req_gathering"></td>
                    ...
                    <button type="submit" name="submit" class="btn btn-primary pull-right">Update Schedule</button>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Projects Schedule</h4>
                  <p class="card-category"> projects Schedule</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
					 ...
					 <?php
							...
							$sql = "SELECT * FROM student_project_schedule";
							//	$result=mysqli_query($db_found,$sql); //rs.open sql,con
							if($result = mysqli_query($db_found, $sql)){
							while ($row=mysqli_fetch_array($result))
							{ 
							$student_id=$row['student_id'];
							$getName = mysqli_fetch_assoc(mysqli_query($db_found, "SELECT name FROM student_profile WHERE id = '$student_id'"));
							$Sname = $getName['name'];
						?><!--open of while -->
							<tr>
