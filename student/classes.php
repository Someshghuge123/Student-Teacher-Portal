...
$username=$_SESSION['username'];
	$getAdd = mysqli_fetch_assoc(mysqli_query($db_found, "SELECT year FROM student_profile where username='$username'"));
										$year = $getAdd['year'];
										?>
<!DOCTYPE html>
<html lang="en">
...
<body class="">
  <div class="wrapper ">
    ...
    <div class="content">
	  ...
	  <div class="row">
	  <?php
	  $sql = "SELECT * FROM classes where year='$year'";
if($result = mysqli_query($db_found, $sql)){
    
        while($row = mysqli_fetch_array($result))
		{ ?>	  
  <div class="col-md-4">
	<a href="class.php?ID=<?php echo $row['id'];?>">
              <div class="card card-chart">
                <div class="card-header card-header-primary">
                  <div class="ct-chart" ></div>
				  <img src="../teacher/upload/1.png" height="100" width="" >
                </div>
                <div class="card-body">
                  <h4 class="card-title"><?php echo $row['class']; ?></h4>
                  <p class="card-category">
                    <span class="text-success"><i class="fa fa-long-arrow-up"></i> Class for </span> <?php echo $row['year']; ?> year </p>
                </div>
