      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="admin.php">Admin Profile</a>
          </div>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql2 = "UPDATE admin_profile SET name='$name',email='$email' where username='$username'";
	...
	else
	{
		if($oldpassword==$studentPass)
		{
			...
			$sql2 = "UPDATE admin_profile SET name='$name',email='$email', password='$password' WHERE username='$username'";
			mysqli_query($db_found,$sql2);
