...
Notice :<textarea type="text" name="notice" cols="30" rows="3" required> </textarea>
...
<button type="submit" name="submit" class="btn btn-primary pull-right">Upload</button>
			...
			<?php 
						if(isset($_POST['submit']))
						{
							$notice=$_POST['notice'];
							//$id4=$_POST['id3'];
							$sql = "INSERT INTO notice (class_id,description) VALUES ('$id','$notice')";
				...
				<div class="col-md-8">
					  <div class="card card-chart">
						...
						<div class="card-body">
						  ...
						  <p class="card-category">
							<span class="text-success"><i class="fa fa-long-arrow-up"></i> share something with your class .. </span> </p>
						</div>
						<div class="card-footer">
						  <div class="stats">
...
<form method="post" action="addnotes.php" enctype="multipart/form-data">
 ...
 <label class="bmd-label-floating">Select File</label>
<input type="file" name="file" >
<br>
 
Description :<textarea type="text" name="description" cols="80" rows="3" required> </textarea>
<input type="hidden" name="class_id" value="<?php echo $id; ?>" >
<button type="submit" name="submit" class="btn btn-primary pull-right">Upload</button>
</form>						
<hr>	
	 ...
	 <div class="col-md-4">
					  ...
					  <div class="card card-chart">
						...
						<div class="card-body">
						  <div class="stats">
							<i class="material-icons"></i>
					<img src="<?php echo $row['path']; ?>" height="100" width="100" ><br>
					<?php $trimmed = str_replace('upload/', '', $row['path']) ;
					?>
					<a class="btn btn-info" href="<?php echo $row['path']; ?>" target="_blank"><?php echo $trimmed ;?>
						...
						<div class="card-footer">
						 <p class="card-category">
							<span class="text-success"><i class="fa fa-long-arrow-up"></i> <?php echo $row['description']; ?> </span> 
								...
								Comments						  			  	  
								<?php
									$getAdd = mysqli_fetch_assoc(mysqli_query($db_found, "SELECT comment FROM notes where id='$id2'"));
