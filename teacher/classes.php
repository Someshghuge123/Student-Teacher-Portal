...
<body class="">
  <div class="wrapper ">
    ...
    <div class="navbar-collapse collapse justify-content-between align-items-center w-100" id="collapsingNavbar2">
	  ...
	  <div class="row">
	  <?php
	  $sql = "SELECT * FROM classes where teacher='$username'";
if($result = mysqli_query($db_found, $sql)){
  ...
  <div class="col-md-4">
	<a href="class.php?ID=<?php echo $row['id'];?>">
              <div class="card card-chart">
                <div class="card-header card-header-primary">
				  ...
				  <img src="upload/1.png" height="100" width="" >
                </div>
                <div class="card-body">
	...
	<a class="btn btn-danger" onclick="return confirmDel()" href="deleteclass.php?ID=<?php echo $row['id'];?>">
